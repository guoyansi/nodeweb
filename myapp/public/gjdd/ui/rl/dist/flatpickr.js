...
function Flatpickr(element, config) {
	...
	function positionCalendar() {
		...
		var setXPos=function(){
			...
			var distanceFromRight=window.innerWidth-inputBounds.right+input.offsetWidth;
			if(distanceFromRight<calendarWidth){
				self.calendarContainer.classList.add("arrowRightTop");
				self.calendarContainer.style.left = (left-225) + "px";
			}
		};
	...
	function setupHelperFunctions() {
		self.utils = {
			...
			monthToStr: function monthToStr(monthNumber) {
				...
				return Flatpickr.l10n.months[t + "hand"][monthNumber];
			}
		};
	}
...
Flatpickr.l10n = {
	...
	months: {
		...
		//numhand: ["一月", "二月", "三月", "四月", "五月", "六月", "七月", "八月", "九月", "十月", "十一月", "十二月"]
	},
